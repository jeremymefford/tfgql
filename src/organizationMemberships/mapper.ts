...
import { OrganizationMembershipResource, OrganizationMembership } from './types';

export const organizationMembershipMapper: DomainMapper<OrganizationMembershipResource, OrganizationMembership> = {
