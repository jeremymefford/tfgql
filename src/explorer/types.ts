...
export type ExplorerViewType = 'workspaces' | 'tf_versions' | 'providers' | 'modules';
...
export type ExplorerTerraformVersionField = 'version' | 'workspace_count' | 'workspaces';
export type ExplorerProviderField = 'name' | 'source' | 'version' | 'workspace_count' | 'workspaces';
export type ExplorerModuleField = 'name' | 'source' | 'version' | 'workspace_count' | 'workspaces';
...
export type ExplorerWorkspaceResource = ResourceObject<ExplorerWorkspaceAttributes>;
export type ExplorerWorkspaceListResponse = ListResponse<ExplorerWorkspaceResource>;

export type ExplorerTerraformVersionResource = ResourceObject<ExplorerTerraformVersionAttributes>;
export type ExplorerTerraformVersionListResponse = ListResponse<ExplorerTerraformVersionResource>;

export type ExplorerProviderResource = ResourceObject<ExplorerProviderAttributes>;
export type ExplorerProviderListResponse = ListResponse<ExplorerProviderResource>;
