...
export interface VariableSetFilter extends WhereClause<VariableSet, {
...
export interface VariableSetPermissionsFilter extends WhereClause<VariableSet['permissions']> {
