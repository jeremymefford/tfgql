...
export const resolvers = {
    Query: {
        ...
        variableSets: async (_: unknown, { includeOrgs, excludeOrgs, filter }: { includeOrgs?: string[], excludeOrgs?: string[], filter?: VariableSetFilter }, ctx: Context): Promise<VariableSet[]> => {
