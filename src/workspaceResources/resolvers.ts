...
export const resolvers = {
  Query: {
    workspaceResources: async (
      _: unknown,
      {
        workspaceId,
        filter,
      }: { workspaceId: string; filter?: WorkspaceResourceFilter },
      ctx: Context,
  ...
  WorkspaceResource: {
    workspace: async (
      ...
      return await ctx.dataSources.workspacesAPI.getWorkspace(
        workspaceResource.workspaceId,
      );
    },
    modifiedByStateVersion: async (
      workspaceResource: WorkspaceResource,
      _: unknown,
      ctx: Context,
      ...
      return ctx.dataSources.stateVersionsAPI.getStateVersion(
        workspaceResource.modifiedByStateVersionId,
      );
    },
  },
};
