...
import {
  ...
  IngressAttributes /*IngressAttributesResponse*/,
} from "./types";
...
export class ConfigurationVersionsAPI {
    ...
    return this.requestCache.getOrSet<ConfigurationVersion | null>(
      ...
      async () => {
        return this.httpClient
          .get<ConfigurationVersionResponse>(`/configuration-versions/${id}`, {
  ...
  async getConfigurationVersionSize(
    downloadUrl: string,
  ): Promise<number | null> {
    return this.requestCache.getOrSet<number | null>(
      "ConfigurationVersion",
      downloadUrl,
      async () => {
