...
export const resolvers = {
    Query: {
        ...
        workspacesWithTFLogCategory: async (_: unknown, { includeOrgs, excludeOrgs, categories }: { includeOrgs: string[], excludeOrgs: string[], categories: string[] }, ctx: Context): Promise<Workspace[]> => {
